      ...
      <div className='d-flex flex-column justify-content-center align-items-center min-vh-100'>
        <div className='text-center text-light p-5'>
          ...
          <div className='text-center'>
            <a href='https://www.linkedin.com/in/rakesh-t-n-154510191/' target='blank'><button className='btn bgbtn text-light m-2'><FontAwesomeIcon icon={faLinkedinIn} style={{color: "#ffffff",}} /> LinkedIn</button></a>
